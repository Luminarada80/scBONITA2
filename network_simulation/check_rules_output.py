...
true_ruleset_path = f'/home/emoeller/github/scBONITA/scBONITA/test_network_rules_{num_genes}g_{num_cells}c_{per_err}e.txt'
test_ruleset_path = f'/home/emoeller/github/scBONITA/scBONITA/rules_output/test_data_{num_genes}g_{num_cells}c_{per_err}e_rules/test_network_{num_genes}g_{num_cells}c_{per_err}e.graphml_test_data_{num_genes}g_{num_cells}c_{per_err}e_ind_1_rules.txt'
