...
First, run the `simulate_cell.py` script to generate cell trajectories for the networks of interest
...
This code first uses dynamic time warping to compute how different each cell's trajectory is 